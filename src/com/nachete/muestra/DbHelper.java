...
public class DbHelper extends SQLiteOpenHelper {
  ...
  public static ContentValues statusToContentValues(MensajeBean status) {
    ContentValues ret = new ContentValues();
    ret.put(C_ID, status.getStatus_id());
    ret.put(C_CREATED_AT, status.getStatus_time_created());
    ret.put(C_TEXT, status.getStatus_text());
    ret.put(C_USER, status.getStatus_username());
    ret.put(C_DESCRIPTION, status.getStatus_blog());
    return ret;
  }
}